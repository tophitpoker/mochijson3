...
%% @doc Yet another JSON (RFC 4627) library for Erlang. mochijson3 works
...
json_encode(I, _State) when is_integer(I) ->
    mochijson3_mochinum:digits(float(I));
json_encode(F, _State) when is_float(F) ->
    mochijson3_mochinum:digits(F);
...
json_encode_string_unicode([C | Cs], State, Acc) ->
    Acc1 = case C of
               ...
               %% in-line. mochijson3 does not protect you from this, so
...
encoder_utf8_test() ->
    ...
    Enc = mochijson3:encoder([{utf8, true}]),
